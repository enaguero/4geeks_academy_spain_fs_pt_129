...
# 🚨 Step 5: Status Codes and Error Handling

## 🎯 Goal

Respond semantically and professionally with the correct HTTP codes.
...
Daily analogy:
- If you go to the bank and they say "ok" to everything, you don't know if your transaction went through.
...
With `HTTPException`, FastAPI already keeps this format.
